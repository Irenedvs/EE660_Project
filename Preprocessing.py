...
def main():
    data = []
    filename = "/Users/irenedavis/Documents/EE660/Final_Proj/test.csv"
    ...
    write_dictionary("/Users/irenedavis/Documents/EE660/Final_Proj/outputs/test-transform.csv", data)
